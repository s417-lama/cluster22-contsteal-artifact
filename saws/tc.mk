...
#GCFLAGS = -O3
GCFLAGS = -DNDEBUG -Wall -rdynamic -O3 -D_POSIX_C_SOURCE=200112L -march=native
...
GCXXFLAGS = -DNDEBUG -Wall -rdynamic -O3 -D_POSIX_C_SOURCE=200112L -march=native
...
$(TC_LIBDIRS): tcheaders
	$(MAKE) -C $@ GCFLAGS="$(GCFLAGS)" CC="$(CC)"

$(TC_LIBMPIDIRS): tcheaders
